...
(8, NULL, NULL, NULL, '2023-07-29 08:04:48', NULL, NULL);
...
(3, 'aboutus', '<span style=\"color: rgb(95, 95, 95); font-family: Muli, sans-serif; letter-spacing: 0.4px; text-align: center;\">‘A journey of a thousand miles begins with a single step – Lao Tzu’. The year of new foundations and the year of new beginnings! With the idea to create a world of affordable tourism and to explore as well as innovate new avenues in the travel industry, we set out on a journey to achieve ‘Our Lakshya - Bharat Ki Sabse Behtareen Travel Company’, a feat we are strongly working towards everyday…</span>'),
(11, 'contact', 'Contact: 1800 22 7979<div>Email: Travel@TripGo.com</div>');
...
(12, 'aakanksha mujumdar', '9130588296', 'mujumdaraakanksha@gmail.com', 'b8c87aea6162d583f00b5045017923e7', '2023-07-29 08:04:48', NULL);
